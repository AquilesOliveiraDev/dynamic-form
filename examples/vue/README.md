...
Projeto funcional de referência em **Vue 3 (Composition API & `<script setup>`)** para o motor `@dynamic-form`, consumindo o mesmo contrato unificado [`TESTE_FINAL/form-schema.json`](../form-schema.json).
