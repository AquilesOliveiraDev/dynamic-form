...
Aplicação **React Native / Expo** independente organizada dentro de `TESTE_FINAL/react-native`, configurada para validar o motor universal **`@dynamic-form/core`** cobrindo com precisão as **10 regras do DynamicField**:
