...
export declare function DynamicFormRoot<TFormData extends Record<string, any> = Record<string, any>>({ schema, renderField, className, rowClassName, fieldClassName, }: DynamicFormRootProps<TFormData>): any;
